    ...
    return createPortal(
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <div className={`relative w-full max-w-6xl h-full max-h-[90vh] flex flex-col rounded-3xl shadow-2xl border overflow-hidden animate-in zoom-in-95 duration-300 ${
                isDark ? 'bg-[#0B0C13] border-white/[0.08]' : 'bg-white border-gray-200'
            }`}>
                
                {/* Header */}
                <div className={`flex items-center justify-between p-5 sm:p-6 border-b ${isDark ? 'border-white/[0.05] bg-[#0B0C13]' : 'border-gray-100 bg-gray-50'}`}>
                    <div className="flex items-center gap-4">
                        {monthData.driver.avatar ? (
                            ...
                            <div className={`w-12 h-12 rounded-full flex items-center justify-center text-lg font-bold ${isDark ? 'bg-[#181A24] text-gray-300' : 'bg-gray-200 text-gray-600'}`}>
                        ...
                        <div>
                            <div className="flex items-center gap-2 mb-0.5">
                                ...
                                <span className={`text-[10px] font-bold uppercase tracking-wider px-2 py-0.5 rounded-full ${isDark ? 'bg-[#181A24] text-gray-400' : 'bg-gray-200 text-gray-600'}`}>
                ...
                <div className="flex-1 overflow-y-auto p-5 sm:p-6 space-y-6">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                        <div className={`p-4 rounded-2xl ${isDark ? 'bg-[#181A24]' : 'bg-gray-50 border border-gray-100'}`}>
                    ...
                    <div>
                        ...
                        <div className={`w-full h-3 rounded-full overflow-hidden ${isDark ? 'bg-[#181A24]' : 'bg-gray-200'}`}>
                            <div 
