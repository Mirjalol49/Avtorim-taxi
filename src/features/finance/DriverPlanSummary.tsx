...
export const DriverPlanSummary: React.FC<DriverPlanSummaryProps> = ({
    ...
    return (
        <div className={`rounded-[32px] border shadow-sm overflow-hidden ${isDark ? 'bg-[#181818] border-white/[0.05]' : 'bg-white border-gray-100'}`}>
            <div className={`flex flex-wrap items-center justify-between gap-4 p-6 border-b ${isDark ? 'border-white/[0.05] bg-[#111111]' : 'border-gray-100 bg-gray-50'}`}>
                    ...
                    {rows.map(row => (
                                ...
                                >
                                    ...
                                    <div className="flex items-start justify-between mb-5">
                                        <div className="flex items-center gap-3.5">
                                            {row.driver.avatar ? (
                                                ...
                                                <div className={`w-12 h-12 rounded-full flex items-center justify-center text-lg font-bold tracking-tight flex-shrink-0 transition-transform duration-500 group-hover:scale-105 ${isDark ? 'bg-[#111111] text-gray-300 border-white/[0.08]' : 'bg-gray-100 text-gray-700 border-gray-200'}`}>
                                    ...
                                    <div className="relative z-10">
                                        ...
                                        <div className={`w-full h-1.5 rounded-full overflow-hidden ${isDark ? 'bg-[#111111]' : 'bg-gray-200/80'}`}>
                                            <div
