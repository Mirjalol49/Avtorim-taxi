...
export const FinancePage: React.FC<FinancePageProps> = ({
    ...
    return (
        <div className="space-y-6 animate-fadeIn">
            ...
            <div className={`p-5 rounded-2xl border ${theme === 'dark' ? 'bg-[#181818] border-white/[0.08]' : 'bg-white border-gray-200'}`}>
                ...
                <div className="flex justify-end">
                    <button
                        ...
                        className={`flex items-center gap-2 px-4 py-2 rounded-xl text-sm font-semibold border transition-all active:scale-95 ${
                            theme === 'dark'
                                ? 'bg-[#111111] border-white/[0.08] text-gray-300 hover:border-emerald-500/40 hover:text-emerald-400 hover:bg-emerald-500/5'
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
                ...
                {/* Yearly Expense */}
                <div className={`p-4 sm:p-5 md:p-6 rounded-xl sm:rounded-2xl border shadow-lg relative overflow-hidden group transition-all ${theme === 'dark' ? 'bg-[#181818] border-white/[0.08]' : 'bg-white border-gray-100'}`}>
                    ...
                    <div className="flex flex-col justify-between relative z-10 gap-2 sm:gap-3">
                        <div className="flex items-center gap-2">
                            <div className={`p-1.5 rounded-lg border flex-shrink-0 ${theme === 'dark' ? 'bg-[#111111] text-red-400 border-white/[0.08]' : 'bg-red-50 text-red-500 border-red-100'}`}>
                ...
                {/* Yearly Net Profit */}
                <div className={`p-4 sm:p-5 md:p-6 rounded-xl sm:rounded-2xl border shadow-lg relative overflow-hidden group transition-all sm:col-span-2 lg:col-span-1 ${theme === 'dark' ? 'bg-[#181818] border-white/[0.08]' : 'bg-white border-gray-100'}`}>
                    <div className={`absolute top-0 right-0 p-3 transition-opacity ${theme === 'dark' ? 'opacity-5 group-hover:opacity-10' : 'opacity-[0.08] group-hover:opacity-[0.12]'}`}>
                        <WalletIcon className={`w-12 sm:w-16 md:w-20 h-12 sm:h-16 md:h-20 ${theme === 'dark' ? 'text-white' : 'text-gray-900'}`} />
                    </div>
                    <div className="flex flex-col justify-between relative z-10 gap-2 sm:gap-3">
                        <div className="flex items-center gap-2">
                            <div className={`p-1.5 rounded-lg border flex-shrink-0 ${theme === 'dark' ? 'bg-[#111111] text-[#0f766e] border-white/[0.08]' : 'bg-[#0f766e]/10 text-[#0f766e] border-[#0f766e]/20'}`}>
            ...
            <div className={`w-full h-[300px] sm:h-[400px] p-4 sm:p-6 rounded-2xl sm:rounded-3xl border flex flex-col shadow-xl ${theme === 'dark' ? 'bg-[#181818] border-white/[0.08]' : 'bg-white border-gray-200'}`}>
