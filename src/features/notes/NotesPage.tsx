            ...
            >
                ...
                <div className="mx-4 mb-3">
                    {!showReminder ? (
                        ...
                        <div className={`rounded-2xl border overflow-hidden ${isDark ? 'bg-[#181A24] border-white/[0.07]' : 'bg-gray-50 border-gray-200'}`}>
                            {/* Header */}
                                ...
                                <div className="flex items-center gap-2">
                                    <input
                                        ...
                                        className={`flex-1 text-xs px-3 py-2.5 rounded-xl border outline-none focus:ring-2 focus:ring-[#0f766e]/40 focus:border-[#0f766e] transition-all font-medium ${
                                            isDark
                                                ? 'bg-[#0B0C13] border-white/[0.08] text-white [color-scheme:dark]'
