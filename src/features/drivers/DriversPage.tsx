            ...
            {filteredDrivers.length > 0 ? (
                <>
                    {viewMode === 'grid' ? (
                        ...
                        <div className={`rounded-2xl border overflow-hidden shadow-lg ${theme === 'dark' ? 'bg-[#2d2e30] border-white/[0.08]' : 'bg-white border-gray-200'}`}>
                            <div className="overflow-x-auto">
                                <table className="w-full text-left border-collapse">
                                    <thead>
                                        <tr className={`${theme === 'dark' ? 'bg-[#232425] text-gray-400' : 'bg-gray-50 text-gray-500'} text-xs uppercase tracking-wider`}>
                        ...
                        <div className="flex justify-center mt-8 gap-2">
                            <button
                                ...
                                className={`px-4 py-2 rounded-xl text-sm font-medium transition-colors ${theme === 'dark'
                                    ? 'bg-[#232425] text-white hover:bg-white/[0.06] disabled:opacity-50 disabled:cursor-not-allowed'
                ...
                <div className={`text-center py-12 ${theme === 'dark' ? 'text-gray-500' : 'text-gray-400'}`}>
                    <div className="bg-gray-100 dark:bg-[#232425] w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
