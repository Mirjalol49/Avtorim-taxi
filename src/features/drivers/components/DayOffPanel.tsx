        ...
        >
            <div
                className={`w-full max-w-md rounded-2xl border shadow-2xl flex flex-col overflow-hidden ${
                    isDark ? 'bg-[#11131B] border-white/[0.08]' : 'bg-white border-gray-200'
                }`}
            ...
            >
                ...
                {/* Add day off form */}
                {!limitReached && (
                    <div className={`mx-5 mt-3 rounded-xl p-3 ${isDark ? 'bg-[#181A24]' : 'bg-gray-50'}`}>
