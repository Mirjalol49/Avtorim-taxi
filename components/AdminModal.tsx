...
const AdminModal: React.FC<AdminModalProps> = ({ isOpen, onClose, adminData, onUpdate, lang }) => {
    ...
    <div className="fixed inset-0 bg-black/70 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      <div className="bg-slate-800 border border-slate-700 rounded-2xl shadow-2xl w-full max-w-md overflow-hidden animate-in fade-in zoom-in duration-200">
        <div className="bg-slate-900/50 px-6 py-5 border-b border-slate-700 flex justify-between items-center">
          <h3 className="text-white font-bold text-lg">{t.editProfile}</h3>
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-5">
          ...
          <div className="flex justify-center mb-6">
            <div className="relative group w-24 h-24 rounded-full overflow-hidden bg-slate-900 border-4 border-slate-700 cursor-pointer hover:border-blue-500 transition-colors">
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-3 bg-slate-900 border border-slate-700 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none text-white text-sm"
              placeholder="https://..."
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-3 bg-slate-900 border border-slate-700 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none text-white font-medium"
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-3 bg-slate-900 border border-slate-700 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none text-white"
            />
          </div>
