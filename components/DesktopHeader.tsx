      ...
      <div className="flex items-center gap-3">
        ...
        <button
          ...
          className={`p-2 rounded-lg border transition-all ${theme === 'dark'
            ? 'bg-[#232425] hover:bg-white/[0.06] border-white/[0.08] text-gray-400 hover:text-gray-200'
        ...
        <div className="relative" ref={langMenuRef}>
          <button
            ...
            className={`flex items-center gap-2 px-3 py-2 rounded-lg border transition-all duration-200 ${theme === 'dark'
              ? 'bg-[#232425] hover:bg-white/[0.06] border-white/[0.08] text-gray-300 hover:text-white'
