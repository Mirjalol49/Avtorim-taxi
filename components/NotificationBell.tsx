                ...
                <div className="px-4 py-4 pr-10">
                    ...
                    <div className="flex items-center gap-3 mb-3">
                        <div className="relative flex-shrink-0">
                            ...
                            {!isRead && (
                                <span className={`absolute -top-1 -right-1 w-2.5 h-2.5 rounded-full bg-orange-400 border-2 ${isDark ? 'border-[#171818]' : 'border-white'}`} />
                            )}
                        </div>
                    ...
                    <div className="mb-2.5">
                        ...
                        <div className={`w-full h-1.5 rounded-full overflow-hidden ${isDark ? 'bg-[#232425]' : 'bg-gray-200'}`}>
                            <div
                    ...
                    <div className={`flex items-center justify-between rounded-xl px-3 py-2 ${isDark ? 'bg-[#232425]/60' : 'bg-gray-50'}`}>
                        <div>
                ...
                <div className="px-4 py-3.5 pr-10">
                    <div className="flex items-start gap-3">
                        ...
                        <div className="relative flex-shrink-0">
                            ...
                            {!isRead && (
                                <span className={`absolute -top-1 -right-1 w-2.5 h-2.5 rounded-full bg-teal-500 border-2 ${isDark ? 'border-[#171818]' : 'border-white'}`} />
                            )}
                        </div>
                            ...
                            <div className="flex flex-wrap items-center gap-1.5 mb-2">
                                ...
                                {chequeUrl && (
                                    <a
                                        ...
                                        className={`inline-flex items-center gap-0.5 text-[10px] px-1.5 py-0.5 rounded-md font-semibold transition-colors ${isDark ? 'bg-[#232425] text-gray-400 hover:bg-white/[0.06] hover:text-white' : 'bg-gray-100 text-gray-500 hover:bg-gray-200 hover:text-gray-700'}`}
                                    >
    ...
    const sidebar = isOpen ? createPortal(
        <>
            ...
            >
                ...
                {/* Footer */}
                {notifications.length > 0 && (
                    <div className={`flex-shrink-0 px-5 py-3 border-t ${isDark ? 'border-white/[0.06] bg-[#2d2e30]' : 'border-gray-100 bg-white'}`}
>
