...
export const LockIcon: React.FC<LockIconProps> = ({
    ...
    return (
        <div className="relative group/lock">
            ...
            {/* Custom Tooltip */}
            <div className="absolute bottom-full mb-2 left-1/2 -translate-x-1/2 px-2 py-1 text-white text-[10px] rounded opacity-0 group-hover/lock:opacity-100 transition-opacity whitespace-nowrap pointer-events-none z-50 font-medium tracking-wide"
                style={{ background: '#111827' }}>
                {tooltipText}
                <div className="absolute top-full left-1/2 -translate-x-1/2 border-4 border-transparent" style={{ borderTopColor: '#111827' }}></div>
            </div>
        </div>
    );
};
