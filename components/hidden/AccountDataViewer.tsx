...
const AccountDataViewer: React.FC<AccountDataViewerProps> = ({ user, onClose }) => {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm">
            <div className="bg-[#111111] rounded-2xl border border-white/[0.08] shadow-2xl w-full max-w-4xl max-h-[90vh] overflow-hidden flex flex-col">
                {/* Header */}
                <div className="flex items-center justify-between p-6 border-b border-white/[0.08] bg-[#080808]/50">
                        ...
                        <>
                            {activeTab === 'overview' && (
                                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                                    <div className="bg-[#080808]/50 rounded-xl p-4 border border-white/[0.08]">
                            ...
                            {activeTab === 'drivers' && (
                                <div className="space-y-3">
                                    {drivers.length === 0 ? (
                                        ...
                                        drivers.map(driver => (
                                            <div key={driver.id} className="flex items-center gap-4 bg-[#080808]/50 rounded-xl p-4 border border-white/[0.08]">
                                                <div className="w-10 h-10 rounded-full bg-[#111111] overflow-hidden">
                                                    {driver.avatar ? (
                                ...
                                <div className="space-y-2">
                                    {transactions.length === 0 ? (
                                        ...
                                        transactions.slice(0, 20).map(tx => (
                                            <div key={tx.id} className="flex items-center justify-between bg-[#080808]/50 rounded-lg p-3 border border-white/[0.08]">
