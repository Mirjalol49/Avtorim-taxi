...
const SuperAdminLogin: React.FC<SuperAdminLoginProps> = ({ onAuthenticated }) => {
    ...
    return (
        <div className="min-h-screen bg-[#080808] flex items-center justify-center p-4">
            <div className="max-w-md w-full bg-[#111111] rounded-2xl shadow-2xl p-8 border border-white/[0.08]">
                ...
                <form onSubmit={handleLogin} className="space-y-6">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            className="w-full bg-[#080808] border border-white/[0.08] rounded-lg px-4 py-3 text-white focus:outline-none focus:border-red-500 transition-colors"
                            placeholder="••••••••"
