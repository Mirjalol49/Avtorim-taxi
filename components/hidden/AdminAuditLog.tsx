...
const AdminAuditLog: React.FC = () => {
    ...
    return (
        <div className="bg-[#111111] rounded-xl border border-white/[0.08] overflow-hidden flex flex-col h-[600px]">
                ...
                <div className="flex gap-3 w-full md:w-auto">
                    <div className="relative flex-1 md:w-64">
                        ...
                        <input
                            ...
                            className="w-full bg-[#080808] border border-white/[0.08] rounded-lg pl-9 pr-4 py-2 text-sm text-white focus:outline-none focus:border-purple-500"
                        />
                    </div>
                    <div className="relative">
                        ...
                        <select
                            ...
                            className="bg-[#080808] border border-white/[0.08] rounded-lg pl-9 pr-8 py-2 text-sm text-white focus:outline-none focus:border-purple-500 appearance-none"
                        >
            ...
            <div className="flex-1 overflow-y-auto">
                <table className="w-full text-left">
                    <thead className="bg-[#080808]/50 text-gray-400 text-xs uppercase tracking-wider sticky top-0 backdrop-blur-sm">
                        <tr>
