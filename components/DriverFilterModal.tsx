            ...
            >
                ...
                <div className={`px-6 py-4 border-b flex-shrink-0 ${isDark ? 'border-white/[0.06]' : 'border-gray-100'}`}>
                    <div className={`flex items-center gap-3 px-4 py-2.5 rounded-xl border ${
                        isDark ? 'bg-[#111111]/60 border-white/[0.08] focus-within:border-teal-500' : 'bg-gray-50 border-gray-200 focus-within:border-teal-500'
                    } transition-colors`}>
                            ...
                            <button
                                ...
                                className={`relative flex flex-col items-center gap-3 p-4 rounded-2xl border-2 transition-all text-left ${
                                    selectedDriverId === 'all'
                                        ...
                                        : isDark
                                            ? 'border-white/[0.06] bg-[#111111]/40 hover:border-white/[0.08] hover:bg-white/[0.04]'
                                    ...
                                    <div className="relative flex-shrink-0">
                                        <div className={`w-14 h-14 rounded-2xl overflow-hidden border-2 ${
                                            ...
                                            {driver.avatar ? (
                                                ...
                                                <div className={`w-full h-full flex items-center justify-center text-xl font-bold ${isDark ? 'bg-[#111111] text-gray-300' : 'bg-gray-200 text-gray-600'}`}>
                                        ...
                                        {car ? (
                                            <>
                                                ...
                                                <div className={`inline-block mt-1.5 text-[10px] font-mono font-bold px-2 py-0.5 rounded-lg ${
                                                    isDark ? 'bg-[#111111] text-gray-300' : 'bg-gray-200 text-gray-600'
                                                }`}>
                                                    {car.licensePlate}
                                                </div>
                                            </>
