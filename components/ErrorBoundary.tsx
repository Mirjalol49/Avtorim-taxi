        ...
        if (this.state.hasError) {
            ...
            return (
                <div className="min-h-screen bg-black flex items-center justify-center p-4">
                    <div className="bg-[#1C1C1E] rounded-2xl border border-white/[0.08] p-8 max-w-4xl w-full text-center">
                        ...
                        <div className="flex gap-3 justify-center">
                            ...
                            <button
                                ...
                                className="px-6 py-2.5 bg-[#2C2C2E] hover:bg-white/[0.06] text-white rounded-xl font-medium transition-colors"
                            >
                                Reload Page
                            </button>
                        </div>
