        ...
        if (this.state.hasError) {
            ...
            return (
                <div className="min-h-screen bg-[#0D0E12] flex items-center justify-center p-4">
                    <div className="bg-[#13141A] rounded-2xl border border-white/[0.08] p-8 max-w-4xl w-full text-center">
                        ...
                        {this.state.error && (
                            <details className="text-left mb-6" open>
                                ...
                                <div className="bg-[#0D0E12] rounded-lg p-4 overflow-auto max-h-[500px] border border-white/[0.08]">
                        ...
                        <div className="flex gap-3 justify-center">
                            ...
                            <button
                                ...
                                className="px-6 py-2.5 bg-[#1C1D23] hover:bg-white/[0.06] text-white rounded-xl font-medium transition-colors"
                            >
                                Reload Page
                            </button>
                        </div>
