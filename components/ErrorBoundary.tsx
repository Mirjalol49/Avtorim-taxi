        ...
        if (this.state.hasError) {
            ...
            return (
                <div className="min-h-screen bg-gray-900 flex items-center justify-center p-4">
                    <div className="bg-gray-800 rounded-2xl border border-gray-700 p-8 max-w-4xl w-full text-center">
                        ...
                        {this.state.error && (
                            <details className="text-left mb-6" open>
                                ...
                                <div className="bg-gray-950 rounded-lg p-4 overflow-auto max-h-[500px] border border-gray-700">
