                ...
                <div className="space-y-4">
                    ...
                    <div>
                        ...
                        <div className="flex rounded-xl border border-white/[0.08] overflow-hidden focus-within:border-teal-500 transition-colors">
                            <span className="bg-[#2C2C2E] px-3 flex items-center text-gray-400 text-sm font-mono border-r border-white/[0.08] select-none">+998</span>
                            <input
                                type="tel"
                                value={phoneDigits}
                    ...
                    <div>
                        ...
                        <div className="flex gap-2">
                            ...
                            <button
                                ...
                                className="px-3 py-3 rounded-xl bg-[#2C2C2E] border border-white/[0.08] text-gray-400 hover:text-teal-400 hover:border-teal-500/50 transition-colors text-xs"
                                title="Yangi parol"
                            >
        ...
        <div className={`bg-black border rounded-2xl p-5 flex flex-col gap-4 transition-all ${account.active ? 'border-white/[0.08] hover:border-white/[0.12]' : 'border-white/[0.05] opacity-60'}`}>
            ...
            <div className="flex items-start gap-3">
                ...
                <button
                    ...
                    className={`relative w-11 h-6 rounded-full transition-colors flex-shrink-0 ${account.active ? 'bg-teal-500' : 'bg-[#2C2C2E]'} ${isSelf ? 'opacity-30 cursor-not-allowed' : 'cursor-pointer'}`}
                >
            ...
            <div className="flex gap-3">
                <div className="flex-1 bg-[#2C2C2E] rounded-xl px-3 py-2 text-center">
            ...
            {showReset && (
                <div className="flex gap-2">
                    <input
                        ...
                        className="flex-1 bg-[#2C2C2E] border border-white/[0.08] rounded-lg px-3 py-2 text-white text-xs font-mono focus:outline-none focus:border-teal-500"
                    />
                    ...
                    <button onClick={() => setShowReset(false)} className="px-3 py-2 rounded-lg bg-[#2C2C2E] text-gray-400 text-xs hover:bg-white/[0.06] transition-colors">✕</button>
                </div>
            )}
    ...
    return (
        <div className="fixed inset-0 z-[200] flex flex-col bg-[#0d1117] overflow-hidden" style={{ animation: 'modalPop 0.2s ease-out' }}>
            ...
            <div className="flex items-center gap-3 px-6 py-4 flex-shrink-0">
                ...
                <button onClick={load} className="p-2.5 rounded-xl bg-[#2C2C2E] border border-white/[0.08] text-gray-400 hover:text-white hover:bg-white/[0.06] transition-colors">
