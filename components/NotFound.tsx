...
const NotFound: React.FC = () => {
    ...
    useEffect(() => {
        ...
        // Note: MorphSVG is a paid plugin. Using attr fallback for basic path switching if possible, 
        // or just simple toggling. For this implementation, we'll try to animate the 'd' attribute directly
        // which works in some browsers/versions or falls back to instant switch.
        chatterTL
            .to(['#mouthBG', '#mouthPath', '#mouthOutline'], { duration: 0.1, attr: { d: mouthShape4 } }, "0")
        ...
        yetiTL
            ...
            .add(() => {
                chatterTL.pause();
                gsap.to(['#mouthBG', '#mouthPath', '#mouthOutline'], { duration: 0.1, attr: { d: mouthShape1 } });
            }, "3.2")
    ...
    return (
        <div className="not-found-container">
            {/* YETI SVG */}
            <svg id="yetiSVG" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 600 470" ref={yetiRef}>
